...
PTMX-predict -p 20 -N 500 -i $feature_positive -o $result_file --positive $feature_positive --negative $feature_negative
...
PTMX-predict -p 10 -i $test_file -o $result_file -m $model_file


## alternative option
# result_file=$dat_dir/interface/test_results_new.txt
# python PTMXtalk/predict.py -p 20 -N 500 -i $feature_positive -o $result_file --positive $feature_positive --negative $feature_negative


# test_file=$dat_dir/interface/testset/dataset_human_results.txt
# result_file=$dat_dir/interface/test_human_new.txt
# model_file=$dat_dir/interface/trained_model_set.pkl
# python PTMXtalk/predict.py -p 10 -i $test_file -o $result_file -m $model_file
